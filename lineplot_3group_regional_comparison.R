...
data_2m = read.csv('C:/Users/yanyanming77/Desktop/Lmeasure_extraction/D1_D2/Lmeasure_extract_all_features/May-20-2024/morpho_2248CPneurons_with_community.csv')
data_12m = read.csv('C:/Users/yanyanming77/Desktop/Lmeasure_extraction/Q140_WT_withD1/Lmeasure_extract_all_features/all_htme_brains_with_registration_1168CPneurons_onlyCP.csv')

dim(data_2m) # 2248, 37
dim(data_12m) # 1167, 36
...
dim(data_combined) # 3415 rows, 38 columns
...
numeric_features = colnames(data_combined[7:37])
...
saveWorkbook(wb, "significance_P56_12mWT_12mQ_differences_in_subregion_by_D1D2_adhoc_comparison.xlsx", overwrite = TRUE)

# 2) adhoc comparison with p-value asterisk labels for plot annotation
input_file = "significance_P56_12mWT_12mQ_differences_in_subregion_by_D1D2_adhoc_comparison.xlsx" 
wb = loadWorkbook(input_file)
  ...
  output_file = "significance_P56_12mWT_12mQ_differences_in_subregion_by_D1D2_adhoc_comparison_asterisk.xlsx"  
saveWorkbook(new_wb, output_file, overwrite = TRUE)

############################################################################################################
######### Line plot: normalized feature distribution in CPr, CPi and CPc, by D1 and D2 #####################
############################################################################################################
pdf(file = "line-plot_averaged_normalized_feature_by_subregion_P56_12m.pdf", wi = 7, he = 9)
scpp(2.5);
par(mar = c(3,5,3,5));
...
############################################################################################################
######### Line plot: normalized feature regional pairwise differences, by D1 and D2 #####################
############################################################################################################
