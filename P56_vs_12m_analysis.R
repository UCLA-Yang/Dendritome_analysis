# work directory
setwd("C:/Users/yanyanming77/Desktop/neuro_shape_analysis/2m_vs_12m/Oct-2024_cleaned")
...
stats1 = subset(stats1, Striatal.Subregion %in% c('CPr', 'CPi', 'CPc'))
dim(stats1) # 2741, 37

table(stats1$Brain)
table(stats1$Age) # 2m: 2248, 12m: 493
table(stats1$Striatal.Subregion) # 456 CPr, 1353 CPi, 932 CPc
table(stats1$Type) # 1439 D1, 1302 D2
...
colnames(stats1)
stats1 = stats1[, c(1:5, 37, 38, 6:36)]
colnames(stats1)
...
colnames(stats[[1]])
non_numericCols = colnames(stats[[1]][, c(1:18)])
