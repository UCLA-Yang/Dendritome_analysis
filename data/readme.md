...
- 2466CPneurons_with_standardized_z.csv:<br>the standardized Z (soma-to-surface) value of all 2466 reconstructed WT MSNs in the P56 dataset
- TME_morpho_box_May-20-2024_2466neurons.csv: <br>the morphometrics and assigned box for all 2466 WT MSNs in the P56 dataset
